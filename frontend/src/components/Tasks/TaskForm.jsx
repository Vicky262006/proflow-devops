...
const TaskForm = ({ initial, onSuccess, onCancel }) => {
  ...
  const [form, setForm] = useState({
    ...
    status: 'todo', deadline: '', assignee: '', team: '', tags: [],
    ...initial,
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label className="label"><Calendar className="inline w-3.5 h-3.5 mr-1" />Deadline</label>
      ...
      <div>
        <label className="label"><Tag className="inline w-3.5 h-3.5 mr-1" />Tags</label>
